...
- clone this repo
- yarn install
- at home page, to make new to-do list or activity, press the 'add new activity' button
- modal will show, type the activity name and choose the background color
- press create button, and new activity created
- to add the task, press on the activity and modal will show up
- type the new task on textInput and press plus button and task created
- if task completed, press the checkbox
